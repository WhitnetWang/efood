...
<div id="header">
		...
		<div id="sidebar">
			<ul>
				...
				<li><a href="javascript:alert('请将您的意见和建议发送至本邮箱710073113@qq.com,谢谢您的支持！！！')"><i class="icon-heart"></i> 意见反馈</a></li>
				<li><a href="dataAnalysis.jsp"><i class="icon-heart"></i> 查看菜品数据</a></li>
			</ul>
		</div>
